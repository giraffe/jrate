// ************************************************************************
//    $Id: Heap.h 416 2004-02-22 18:35:45Z corsaro $
// ************************************************************************
//
//                                jRate
//
...
//  
// *************************************************************************
#ifndef _JRATE_BINDING_JAVA_HEAP_H_
#define _JRATE_BINDING_JAVA_HEAP_H_
...
#include "jrate/binding/java/HAllocator.h"
    ...
    namespace binding {
       namespace java {
            typedef ::jrate::mem::MemoryArea <
                ...
                ::jrate::binding::java::HAllocator_t,
                ...
                | ::jrate::mem::SAFE_REFERENCE_MEMORY > Heap_t;
        }
    }
}


#endif // _JRATE_BINDING_JAVA_HEAP_H_
