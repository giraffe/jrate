...
const struct c_test insn_conditions[] = {
  ...
  { "!TARGET_128BIT_LONG_DOUBLE\n\
   ...
   && (reload_in_progress || reload_completed\n\
    ...
    MAYBE_EVAL (!TARGET_128BIT_LONG_DOUBLE
   && !optimize_size
   && (GET_CODE (operands[0]) != MEM || GET_CODE (operands[1]) != MEM)
   && (reload_in_progress || reload_completed
       || GET_CODE (operands[1]) != CONST_DOUBLE
  ...
  { "!TARGET_128BIT_LONG_DOUBLE && optimize_size",
    MAYBE_EVAL (!TARGET_128BIT_LONG_DOUBLE && optimize_size) },
  ...
  { "!TARGET_128BIT_LONG_DOUBLE && TARGET_80387",
    MAYBE_EVAL (!TARGET_128BIT_LONG_DOUBLE && TARGET_80387) },
  ...
  { "!TARGET_128BIT_LONG_DOUBLE && TARGET_80387 && reload_completed",
    MAYBE_EVAL (!TARGET_128BIT_LONG_DOUBLE && TARGET_80387 && reload_completed) },
  ...
  { "!TARGET_128BIT_LONG_DOUBLE && TARGET_80387 && !TARGET_NO_FANCY_MATH_387",
    MAYBE_EVAL (!TARGET_128BIT_LONG_DOUBLE && TARGET_80387 && !TARGET_NO_FANCY_MATH_387) },
  { "TARGET_80387 && reload_completed\n\
  ...
  { "!TARGET_128BIT_LONG_DOUBLE && TARGET_CMOVE",
    MAYBE_EVAL (!TARGET_128BIT_LONG_DOUBLE && TARGET_CMOVE) },
  ...
  { "!TARGET_128BIT_LONG_DOUBLE && ! TARGET_NO_FANCY_MATH_387 && TARGET_80387\n\
   && flag_unsafe_math_optimizations",
    MAYBE_EVAL (!TARGET_128BIT_LONG_DOUBLE && ! TARGET_NO_FANCY_MATH_387 && TARGET_80387
   && flag_unsafe_math_optimizations) },
  { "!TARGET_ZERO_EXTEND_WITH_AND || optimize_size",
    MAYBE_EVAL (!TARGET_ZERO_EXTEND_WITH_AND || optimize_size) },
  ...
  { "!TARGET_128BIT_LONG_DOUBLE && TARGET_80387 && TARGET_USE_FIOP",
    MAYBE_EVAL (!TARGET_128BIT_LONG_DOUBLE && TARGET_80387 && TARGET_USE_FIOP) },
  { "TARGET_PREFETCH_SSE && TARGET_64BIT",
    MAYBE_EVAL (TARGET_PREFETCH_SSE && TARGET_64BIT) },
...
const size_t n_insn_conditions = 469;
