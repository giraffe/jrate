// ************************************************************************
//    $Id: LTPrivateAllocator.h 416 2004-02-22 18:35:45Z corsaro $
// ************************************************************************
//
//                                jRate
//
...
#define _JRATE_BINDING_JAVA_LT_PRIVATE_ALLOCATOR_H_
    ...
    namespace binding {
        namespace java {
            typedef ::jrate::mem::StackAllocator<
                ...
                ::java::lang::Object*> LTPrivateAllocator_t;
        }
    }
}

#endif // _JRATE_BINDING_JAVA_LT_PRIVATE_ALLOCATOR_H_
