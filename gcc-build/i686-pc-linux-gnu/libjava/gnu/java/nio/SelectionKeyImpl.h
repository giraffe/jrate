...
{
public:
  SelectionKeyImpl (::java::nio::channels::SelectableChannel *, ::gnu::java::nio::SelectorImpl *, jint);
  virtual ::java::nio::channels::SelectableChannel *channel () { return ch; }
  virtual jint readyOps () { return readyOps__; }
  virtual ::java::nio::channels::SelectionKey *readyOps (jint);
  virtual jint interestOps () { return interestOps__; }
