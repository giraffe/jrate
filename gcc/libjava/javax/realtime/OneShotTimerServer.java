// ************************************************************************
//    $Id: OneShotTimerServer.java 416 2004-02-22 18:35:45Z corsaro $
// ************************************************************************
//
//                                jRate
//
...
interface OneShotTimerServer {
     ...
     *
     * @param timer a <code>OneShotTimer</code> 
     */
    void registerTimer(OneShotTimer timer);
     ...
     * @param timer a <code>OneShotTimer</code> 
     */
    void unregisterTimer(OneShotTimer timer);
     ...
     * @param timer a <code>OneShotTimer</code> 
     */
    void schedule(OneShotTimer timer);
     ...
     * @param timer a <code>OneShotTimer</code> 
     */
    void deschedule(OneShotTimer timer);
