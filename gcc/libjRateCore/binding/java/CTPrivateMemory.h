// ************************************************************************
//    $Id: CTPrivateMemory.h 416 2004-02-22 18:35:45Z corsaro $
// ************************************************************************
//
//                                jRate
//
...
//  
// *************************************************************************
#ifndef _JRATE_BINDING_JAVA_CT_PRIVATE_MEMORY_H_
#define _JRATE_BINDING_JAVA_CT_PRIVATE_MEMORY_H_
...
#include "jrate/binding/java/CTPrivateAllocator.h"
    ...
    namespace binding {
        namespace java {
            typedef ::jrate::mem::MemoryArea <
                ...
                ::jrate::binding::java::CTPrivateAllocator_t,
