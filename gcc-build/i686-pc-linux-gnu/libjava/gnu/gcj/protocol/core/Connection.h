...
#ifndef __gnu_gcj_protocol_core_Connection__
#define __gnu_gcj_protocol_core_Connection__
...
class ::gnu::gcj::protocol::core::Connection : public ::java::net::URLConnection
{
public:
...
#endif /* __gnu_gcj_protocol_core_Connection__ */
