// ************************************************************************
//    $Id: RefCountedArenaAllocator.h 416 2004-02-22 18:35:45Z corsaro $
// ************************************************************************
//
//                                jRate
//
...
//  
// *************************************************************************
#ifndef _JRATE_BINDING_JAVA_REF_COUNTED_ARENA_ALLOCATOR_H_
#define _JRATE_BINDING_JAVA_REF_COUNTED_ARENA_ALLOCATOR_H_
    ...
    namespace binding {
        namespace java {
            typedef ::jrate::mem::StackAllocator<
                ...
                ::jrate::binding::java::ObjectInitializer<javax::realtime::RefCountedArena >,
                ::jrate::binding::java::Finalizer_t,
                ::jrate::mem::ZeroBufInitializer,
                ::jrate::mem::ZeroRecycler,
                ::java::lang::Object*> RefCountedArenaAllocator_t;
        }
    }
}

#endif // _JRATE_BINDING_JAVA_REF_COUNTED_ARENA_ALLOCATOR_H_
