...
private:
  ...
  ::java::lang::StackTraceElement *dladdrLookup (::java::lang::Throwable *, ::gnu::gcj::RawData *, jint);
  ::java::lang::String *getAddrAsString (::gnu::gcj::RawData *, jint);
  ::java::lang::String *getExternalLabel (::java::lang::String *);
  ::java::lang::StackTraceElement *lookupInterp (::java::lang::Throwable *, ::gnu::gcj::RawData *, jint);
  ::java::lang::StackTraceElement *lookup0 (::java::lang::Throwable *, ::gnu::gcj::RawData *, jint);
public:
...
private:
  ...
  ::java::lang::StackTraceElement *createStackTraceElement (::java::lang::Throwable *, ::java::lang::String *, ::java::lang::String *);
