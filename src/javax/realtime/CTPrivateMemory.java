// ************************************************************************
//    $Id: CTPrivateMemory.java 416 2004-02-22 18:35:45Z corsaro $
// ************************************************************************
//
//                                jRate
//
...
/**
 * The <code>CTPrivateMemory</code> provides constant time allocation
 ...
 * @version 1.0
 */
public class CTPrivateMemory extends PrivateScopedMemory {
    
    /**
     * Creates a new <code>CTPrivateMemory</code> instance.
     *
     ...
     */
    public CTPrivateMemory(long minSize, long maxSize) {
        this(maxSize, null);
    }
     ...
     */
    public CTPrivateMemory(long size, Runnable logic) {
        super(size, logic);
    }
     ...
     */
    public CTPrivateMemory(SizeEstimator size, Runnable logic) {
