// ************************************************************************
//    $Id: ImmortalMemory.h 416 2004-02-22 18:35:45Z corsaro $
// ************************************************************************
//
//                                jRate
//
...
//  
// *************************************************************************
#ifndef _JRATE_BINDING_JAVA_IMMORTAL_MEMORY_H_
#define _JRATE_BINDING_JAVA_IMMORTAL_MEMORY_H_
...
#include "jrate/binding/java/IMAllocator.h"
    ...
    namespace binding {
        namespace java {
            typedef ::jrate::mem::MemoryArea <
                ...
                ::jrate::binding::java::IMAllocator_t,
...
#endif // _JRATE_BINDING_JAVA_IMMORTAL_MEMORY_H_
