...
{
public:
  static ::java::nio::LongBuffer *allocateDirect (jint);
  static ::java::nio::LongBuffer *allocate (jint);
  static ::java::nio::LongBuffer *wrap (jlongArray, jint, jint);
  static ::java::nio::LongBuffer *wrap (::java::lang::String *);
...
public:  // actually protected
  jlongArray __attribute__((aligned(__alignof__( ::java::nio::Buffer ))))  backing_buffer;
  jint array_offset;
public:
